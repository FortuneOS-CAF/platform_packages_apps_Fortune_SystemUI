 ...
 */
package org.fortune.systemui.volume.dagger;
...
import org.fortune.systemui.volume.FortuneVolumeUI;
...
import org.fortune.systemui.tristate.dagger.TriStateModule;
import org.fortune.systemui.volume.FortuneVolumeDialogComponent;
import dagger.Binds;
import dagger.Lazy;
...
public interface FortuneVolumeModule {
    ...
    @Binds
    @IntoMap
    @ClassKey(FortuneVolumeUI.class)
    CoreStartable bindVolumeUIStartable(FortuneVolumeUI impl);

    /** Listen to config changes for VolumeUI. */
    @Binds
    @IntoSet
    ConfigurationController.ConfigurationListener bindVolumeUIConfigChanges(FortuneVolumeUI impl);

    /**  */
    @Binds
    VolumeComponent provideVolumeComponent(FortuneVolumeDialogComponent volumeDialogComponent);
